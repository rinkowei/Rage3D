-- Rage2D physics Constraints sample.
...
function CreateScene()
    ...
    staticSprite.sprite = cache:GetResource("Sprite2D", "Rage2D/Ball.png")
    ...
    -- Create a ConstraintFriction2D ********** Not functional. From Box2d samples it seems that 2 anchors are required, Rage2D only provides 1, needs investigation ***********
