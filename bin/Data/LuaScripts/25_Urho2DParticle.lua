...
function CreateScene()
    ...
    local particleEffect = cache:GetResource("ParticleEffect2D", "Rage2D/sun.pex")
    ...
    local greenSpiralEffect = cache:GetResource("ParticleEffect2D", "Rage2D/greenspiral.pex")
