...
function CreateCharacter(info, createObject, friction, position, scale)
    ...
    local animationSet = cache:GetResource("AnimationSet2D", "Rage2D/imp/imp.scml")
...
function CreateOrc()
    ...
    local animationSet = cache:GetResource("AnimationSet2D", "Rage2D/Orc/Orc.scml")
    animatedSprite.animationSet = animationSet
...
function CreateCoin()
    ...
    local animationSet = cache:GetResource("AnimationSet2D", "Rage2D/GoldIcon.scml")
    animatedSprite.animationSet = animationSet
    animatedSprite.animation = "idle"
