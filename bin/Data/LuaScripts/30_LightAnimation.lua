...
function CreateScene()
    ...
    spriteAnimation:SetKeyFrame(0.0, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/1.png")))
    spriteAnimation:SetKeyFrame(0.1, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/2.png")))
    spriteAnimation:SetKeyFrame(0.2, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/3.png")))
    spriteAnimation:SetKeyFrame(0.3, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/4.png")))
    spriteAnimation:SetKeyFrame(0.4, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/5.png")))
    spriteAnimation:SetKeyFrame(0.5, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/1.png")))
