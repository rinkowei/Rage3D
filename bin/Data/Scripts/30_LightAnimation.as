...
void CreateScene()
{
    ...
    spriteAnimation.SetKeyFrame(0.0f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/1.png")));
    spriteAnimation.SetKeyFrame(0.1f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/2.png")));
    spriteAnimation.SetKeyFrame(0.2f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/3.png")));
    spriteAnimation.SetKeyFrame(0.3f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/4.png")));
    spriteAnimation.SetKeyFrame(0.4f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/5.png")));
    spriteAnimation.SetKeyFrame(0.5f, Variant(ResourceRef("Texture2D", "Rage2D/GoldIcon/1.png")));
