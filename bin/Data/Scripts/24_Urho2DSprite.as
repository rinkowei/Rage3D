...
void CreateScene()
{
    ...
    Sprite2D@ sprite = cache.GetResource("Sprite2D", "Rage2D/Aster.png");
    if (sprite is null)
        return;
    ...
    AnimationSet2D@ animationSet = cache.GetResource("AnimationSet2D", "Rage2D/GoldIcon.scml");
