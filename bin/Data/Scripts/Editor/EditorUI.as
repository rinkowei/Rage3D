...
void CreateUI()
{
    ...
    graphics.windowIcon = cache.GetResource("Image", "Textures/RageIcon.png");
...
void UpdateWindowTitle()
{
    ...
    if (sceneModified)
        sceneName += "*";
    graphics.windowTitle = "Rage3D editor - " + sceneName;
}
...
XMLFile@ GetEditorUIXMLFile(const String&in fileName)
{
    ...
    // to an outdated Rage installation
