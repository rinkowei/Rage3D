...
# Modified by Yao Wei Tjong for Rage3D
...
macro(_test_compiler_hidden_visibility)
  ...
  if(NOT GCC_TOO_OLD
    ...
    # Rage3D - set the flags in a variable before testing
...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  # Rage3D: always generate header file regardless of target type
    if(WIN32 OR CYGWIN)
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  # Rage3D: Our revised version does not depend on the target to be added first, so always derive the variable value from target name instead
...
# Rage3D: revise to pass the library type by argument so that it does not depend on the target to be added first
